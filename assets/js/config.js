...
window.NL_CONFIG = {
  ...
  address:   "Calle Ramón Gallud 48, 03181 Torrevieja, Alicante, España",

  /* Social */
  instagram: "https://instagram.com/nailslindes",

  /* Google Maps embed src (Share → Embed a map → copy src=""). Optional. */
  mapEmbed: "https://www.google.com/maps?q=Calle+Ram%C3%B3n+Gallud+48,+03181+Torrevieja,+Alicante&output=embed",
